...
static const char *fonts[]          = { "SourceCodePro:size=13", "MesloLGS NF" };
...
/* key definitions */
// use super (windows) key instead of Alt (mod1) since Alt is used by many
// applications (e.g. firefox to jump to tabs).
